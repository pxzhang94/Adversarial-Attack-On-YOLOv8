...
prefixes_descend = ("fgsm", "pgd", "cw", 'gaussian_blur', 'defocus_blur', 'motion_blur', 'gaussian_noise', 'salt_pepper_noise', 'poisson_noise')
...
if __name__ == "__main__":
    run(mode='upload', model_file='./vgg_cifar10_best.pt', input_folder="./demo_classification")
