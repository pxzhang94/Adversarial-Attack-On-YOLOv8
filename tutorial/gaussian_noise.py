...
# output_folder = f"./test_images/gaussian_noise_{std}/images"
# # input_folder = "./Vietnam-Traffic-Sign-Detection-6/test/images"
# # label_folder = "./Vietnam-Traffic-Sign-Detection-6/test/labels"
# # output_folder = f"./Vietnam-Traffic-Sign-Detection-6/gaussian_noise_{std}/images"
...
#             continue
#         noisy_image = apply_gaussian_noise(image, std=std)
#         cv2.imwrite(output_path, noisy_image)
# shutil.copytree(label_folder, f"./Vietnam-Traffic-Sign-Detection-6/gaussian_noise_{std}/labels")